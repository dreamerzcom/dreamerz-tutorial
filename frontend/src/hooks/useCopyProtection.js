 ...
 *   - Right-click outside form inputs
 *
 ...
 *
 * Note (2026-06): previously this hook also wrapped getDisplayMedia and
 * toggled body.tab-hidden on visibilitychange/blur to blur lesson
 * content under those triggers. Both reactions caused UX problems
 * (DevTools/screenshot tools triggered the blur, making content
 * unreadable in normal use) and were removed alongside the watermark
 * overlay. Invisible deterrence stays; visible reactions don't.
 */
